window.settings.i18n['zh-CN'] = {
  ...
  '立即加入': '立即加入',
    ...
    'ios_confirm_info': '如果你是iOS用户，在您购买套餐之前，请确保您已经准备好了小火箭（Shadowrocket）、Sing-box等客户端。这些客户端是iOS平台上使用我们的VPN服务所必需的工具。请确认您已经准备好了这些客户端，以便您能够顺利地使用我们的节点。安卓用户点【确认】忽略本提示。',
