window.settings.i18n['zh-CN'] = {
  ...
  '已取消': '已取消',
  '订单由于超时支付已被取消。': '订单由于超时支付已被取消。【如果您确实已经支付但仍然显示取消，请您将支付宝/微信的支付截图（要能看见订单号）发送到我们的邮箱： support@v2pass.net 客服看见后会第一时间审核处理，感谢您的支持。】',
  '已完成': '已完成',
  '订单已支付并开通。': '订单已支付并开通。',
  '选择订阅': '选择订阅',
  '立即订阅': '立即订阅',
  ...
  '下单': '下单',
  '总计': '总计',
  '变更订阅会导致当前订阅被新订阅覆盖，请注意。': '请注意，变更订阅会导致当前订阅被新订阅覆盖。若购买私人影院，请忽略本提示（因为不会替换您的现有套餐，放心买）',
  '该订阅无法续费': '该订阅无法续费',
  '选择其他订阅': '选择其它订阅',
  '我的钱包': '我的钱包',
  '账户余额(仅消费)': '账户余额(仅消费)',
  ...
  '向机器人发送你的': '把下面粉红色的内容（以/bind开头）全部复制，发送给机器人，即可绑定。请勿泄露给除机器人以外的任何人',
  '使用文档': '使用文档',
  '最后更新: {date}': '最后更新: {date}',
  '复制成功': '复制成功',
  '还有没支付的订单': '还有没支付的订单',
  ...
  '立即加入': '立即加入',
    ...
    'purchase_plan_t1_info_2': '订阅分：按周期、按流量、随用随付 3种。按周期的订阅将在每月的订单日自动重置流量；按流量的订阅则不会重置，流量用完为止；随用随付套餐支付一次性的设置费后，按照流量单价计费，用多少扣多少，无其他额外费用。',
    ...
    'invitation_code_note_info1': '我们将严厉对待滥用邀请码的用户，邀请码仅适用于分享给其他人，请勿“自我推荐”，一经查出，封号处理。',
    'invitation_code_note_info2': '请保护好自己。有关部门 24 小时监控您的一言一行，请勿在国内任何一家社交平台上公开发布您的邀请链接，包括但不限于微信、QQ、Bilibili、抖音、知乎、微博，在国内网站公开分享邀请链接将很容易导致您陷入危险境地。如需分享，请通过 私信 分享给朋友，推荐在邀请链接中插入一些表情或符号。',
    'invitation_code_note_info3':'请注意邀请链接中的域名是否被墙。如邀请链接： https://a.com/#/register?code=XXX 假如 a.com 是被墙的，而 b.com 是好的，则替换成 b.com 。 另外，官网屏蔽国产浏览器，请您告知对方如何下载 Chrome 等浏览器，可在【使用文档】中找到浏览器的下载链接。',
    'invitation_code_note_info4':'邀请码仅限付费用户，如果您的套餐过期超过7天以上，您的邀请码将会被删除。',
    ...
    'sub_request_info2': '规则如下：系统在您每次更新订阅时，会记录您的请求IP。若6小时内不同请求IP数超过12个，您将被暂时阻止更新订阅。',
    ...
    'ios_confirm_info': '如果您是iOS用户，在您购买套餐之前，请确保您已经准备好了小火箭（Shadowrocket）或者 Sing-box等客户端。这些客户端是iOS平台上使用我们的VPN服务所必需的工具。请确认您已经准备好了上述客户端，以便您能够顺利地使用我们的节点。安卓用户点【确认】忽略本提示。购买私人影院，也请忽略本提示。',
