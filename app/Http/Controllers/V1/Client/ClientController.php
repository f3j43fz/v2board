...
class ClientController extends Controller
{
    public function subscribe(Request $request)
    {
        ...
        $allowedFlags = ['clash', 'meta', 'clash-verge', 'shadowrocket', 'sing-box', 'loon', 'clashforandroid', 'clashforwindows', 'quantumult', 'sagerNet', 'surge', 'v2ray', 'passwall', 'ssrplus', 'shadowsocks', 'netch', 'passwall'];
