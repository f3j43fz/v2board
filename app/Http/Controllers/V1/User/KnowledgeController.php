...
class KnowledgeController extends Controller
{
    ...
    private function formatAccessData(&$body)
    {
        while (strpos($body, '<!--access start-->') !== false) {
            ...
            if ($accessData) {
                $body = str_replace($accessData, '<div class="v2board-no-access">'. __("您必须拥有有效的订阅才可以查看该区域的内容") . '<br><br>' . '<a class="btn btn-hero-primary" style="color:#f5f8fa;" href="#/plan">购买订阅</a>' . '</div>', $body);
            }
        }
    }
}
